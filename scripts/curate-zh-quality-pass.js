...
const replacements = [
  ...
  ["文学与诗歌", "现代诗", 4, "吉檀迦利", "[印] 泰戈尔 / 1912", "9780486414172"],
  ["文学与诗歌", "现代诗", 5, "荒原", "[英] T. S. 艾略特 / 1922", "9780156948791"],
  ["文学与诗歌", "现代诗", 6, "杜伊诺哀歌", "[奥] 里尔克 / 1923", "9780393328844"],
  ["文学与诗歌", "戏剧", 4, "俄狄浦斯王", "[古希腊] 索福克勒斯", "9780156027649"],
  ["历史与记忆", "中世纪", 3, "中世纪文明", "[法] 雅克·勒高夫 / 1964", "9780631218460"],
  ...
  ["生活与身体", "时尚", 3, "时尚之书", "Phaidon 编", "9780714871073"],
...
function main() {
  ...
  for (const [category, shelf, slot, title, author, isbn] of replacements) {
    ...
    rows[index] = [category, shelf, slot - 1, title, author, `https://openlibrary.org/isbn/${isbn}`, coverFor(isbn)];
    changes.push({ number: String(index + 1).padStart(4, "0"), before: before[3], after: title });
  }
